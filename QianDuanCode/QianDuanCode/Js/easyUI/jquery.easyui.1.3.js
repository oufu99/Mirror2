...
var t=$.data(_b6,"tree");if(t.options.onlyLeafCheck){var node=_bd(_b6, _ba[0]);var t1 = $(t).tree;var isLeaf=t1('isLeaf',node.target);if(!isLeaf){return false;}}_15d(_b6,_ba[0]);
...
if(opts.showSearch){$("<div class=\"treeSearch\"><input type=\"text\" class=\"treeSearchtxt\" style=\"margin:3px;\"><input type=\"button\" class=\"treeSearchbt\" value=\"查询\" onclick=\"_searchtree(this)\" ></div>").insertBefore($(this));}var data=_ad(this);
...
if($.fn.validatebox){
var t=$(_404);
t.find(".validatebox-text").removeClass("validatebox-invalid");
...
var opts=$(this).combogrid("options");
return (row[opts.textField].indexOf(q) > -1 || row[opts.idField].indexOf(q) > -1);
}});
})(jQuery);
(function($){
function _852(_853){
